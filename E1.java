/**  E1 demultiplexer, revision 14
  ...
  *    Added Unrolled_1_2:    Inner loop unrolled fully; outer loop unrolled by the factor of 2
  *    Added Unrolled_1_4:    Inner loop unrolled fully; outer loop unrolled by the factor of 4
  *    Added Unrolled_1_8:    Inner loop unrolled fully; outer loop unrolled by the factor of 8
  *    Added Unrolled_1_16:   Inner loop unrolled fully; outer loop unrolled by the factor of 16
  */
    ...
    static final class Unrolled_1_2 implements Demux
    {
        public void demux (byte[] src, byte[][] dst)
        {
            ...
            for (int j = 0; j < NUM_TIMESLOTS; j+=2) {
                byte[] d;
                d = dst[j+0];
                d[ 0] = src[j+0+32* 0]; d[ 1] = src[j+0+32* 1]; d[ 2] = src[j+0+32* 2]; d[ 3] = src[j+0+32* 3];
                d[ 4] = src[j+0+32* 4]; d[ 5] = src[j+0+32* 5]; d[ 6] = src[j+0+32* 6]; d[ 7] = src[j+0+32* 7];
                d[ 8] = src[j+0+32* 8]; d[ 9] = src[j+0+32* 9]; d[10] = src[j+0+32*10]; d[11] = src[j+0+32*11];
                d[12] = src[j+0+32*12]; d[13] = src[j+0+32*13]; d[14] = src[j+0+32*14]; d[15] = src[j+0+32*15];
                d[16] = src[j+0+32*16]; d[17] = src[j+0+32*17]; d[18] = src[j+0+32*18]; d[19] = src[j+0+32*19];
                d[20] = src[j+0+32*20]; d[21] = src[j+0+32*21]; d[22] = src[j+0+32*22]; d[23] = src[j+0+32*23];
                d[24] = src[j+0+32*24]; d[25] = src[j+0+32*25]; d[26] = src[j+0+32*26]; d[27] = src[j+0+32*27];
                d[28] = src[j+0+32*28]; d[29] = src[j+0+32*29]; d[30] = src[j+0+32*30]; d[31] = src[j+0+32*31];
                d[32] = src[j+0+32*32]; d[33] = src[j+0+32*33]; d[34] = src[j+0+32*34]; d[35] = src[j+0+32*35];
                d[36] = src[j+0+32*36]; d[37] = src[j+0+32*37]; d[38] = src[j+0+32*38]; d[39] = src[j+0+32*39];
                d[40] = src[j+0+32*40]; d[41] = src[j+0+32*41]; d[42] = src[j+0+32*42]; d[43] = src[j+0+32*43];
                d[44] = src[j+0+32*44]; d[45] = src[j+0+32*45]; d[46] = src[j+0+32*46]; d[47] = src[j+0+32*47];
                d[48] = src[j+0+32*48]; d[49] = src[j+0+32*49]; d[50] = src[j+0+32*50]; d[51] = src[j+0+32*51];
                d[52] = src[j+0+32*52]; d[53] = src[j+0+32*53]; d[54] = src[j+0+32*54]; d[55] = src[j+0+32*55];
                d[56] = src[j+0+32*56]; d[57] = src[j+0+32*57]; d[58] = src[j+0+32*58]; d[59] = src[j+0+32*59];
                d[60] = src[j+0+32*60]; d[61] = src[j+0+32*61]; d[62] = src[j+0+32*62]; d[63] = src[j+0+32*63];
                d = dst[j+1];
                d[ 0] = src[j+1+32* 0]; d[ 1] = src[j+1+32* 1]; d[ 2] = src[j+1+32* 2]; d[ 3] = src[j+1+32* 3];
                d[ 4] = src[j+1+32* 4]; d[ 5] = src[j+1+32* 5]; d[ 6] = src[j+1+32* 6]; d[ 7] = src[j+1+32* 7];
                d[ 8] = src[j+1+32* 8]; d[ 9] = src[j+1+32* 9]; d[10] = src[j+1+32*10]; d[11] = src[j+1+32*11];
                d[12] = src[j+1+32*12]; d[13] = src[j+1+32*13]; d[14] = src[j+1+32*14]; d[15] = src[j+1+32*15];
                d[16] = src[j+1+32*16]; d[17] = src[j+1+32*17]; d[18] = src[j+1+32*18]; d[19] = src[j+1+32*19];
                d[20] = src[j+1+32*20]; d[21] = src[j+1+32*21]; d[22] = src[j+1+32*22]; d[23] = src[j+1+32*23];
                d[24] = src[j+1+32*24]; d[25] = src[j+1+32*25]; d[26] = src[j+1+32*26]; d[27] = src[j+1+32*27];
                d[28] = src[j+1+32*28]; d[29] = src[j+1+32*29]; d[30] = src[j+1+32*30]; d[31] = src[j+1+32*31];
                d[32] = src[j+1+32*32]; d[33] = src[j+1+32*33]; d[34] = src[j+1+32*34]; d[35] = src[j+1+32*35];
                d[36] = src[j+1+32*36]; d[37] = src[j+1+32*37]; d[38] = src[j+1+32*38]; d[39] = src[j+1+32*39];
                d[40] = src[j+1+32*40]; d[41] = src[j+1+32*41]; d[42] = src[j+1+32*42]; d[43] = src[j+1+32*43];
                d[44] = src[j+1+32*44]; d[45] = src[j+1+32*45]; d[46] = src[j+1+32*46]; d[47] = src[j+1+32*47];
                d[48] = src[j+1+32*48]; d[49] = src[j+1+32*49]; d[50] = src[j+1+32*50]; d[51] = src[j+1+32*51];
                d[52] = src[j+1+32*52]; d[53] = src[j+1+32*53]; d[54] = src[j+1+32*54]; d[55] = src[j+1+32*55];
                d[56] = src[j+1+32*56]; d[57] = src[j+1+32*57]; d[58] = src[j+1+32*58]; d[59] = src[j+1+32*59];
                d[60] = src[j+1+32*60]; d[61] = src[j+1+32*61]; d[62] = src[j+1+32*62]; d[63] = src[j+1+32*63];
            }
        }
    }

    static final class Unrolled_1_4 implements Demux
    {
        public void demux (byte[] src, byte[][] dst)
        {
            assert NUM_TIMESLOTS == 32;
            ...
            for (int j = 0; j < NUM_TIMESLOTS; j+=4) {
                byte[] d;
                d = dst[j+0];
                d[ 0] = src[j+0+32* 0]; d[ 1] = src[j+0+32* 1]; d[ 2] = src[j+0+32* 2]; d[ 3] = src[j+0+32* 3];
                d[ 4] = src[j+0+32* 4]; d[ 5] = src[j+0+32* 5]; d[ 6] = src[j+0+32* 6]; d[ 7] = src[j+0+32* 7];
                ...
                d[60] = src[j+1+32*60]; d[61] = src[j+1+32*61]; d[62] = src[j+1+32*62]; d[63] = src[j+1+32*63];
                d = dst[j+2];
                d[ 0] = src[j+2+32* 0]; d[ 1] = src[j+2+32* 1]; d[ 2] = src[j+2+32* 2]; d[ 3] = src[j+2+32* 3];
                d[ 4] = src[j+2+32* 4]; d[ 5] = src[j+2+32* 5]; d[ 6] = src[j+2+32* 6]; d[ 7] = src[j+2+32* 7];
                d[ 8] = src[j+2+32* 8]; d[ 9] = src[j+2+32* 9]; d[10] = src[j+2+32*10]; d[11] = src[j+2+32*11];
                d[12] = src[j+2+32*12]; d[13] = src[j+2+32*13]; d[14] = src[j+2+32*14]; d[15] = src[j+2+32*15];
                d[16] = src[j+2+32*16]; d[17] = src[j+2+32*17]; d[18] = src[j+2+32*18]; d[19] = src[j+2+32*19];
                d[20] = src[j+2+32*20]; d[21] = src[j+2+32*21]; d[22] = src[j+2+32*22]; d[23] = src[j+2+32*23];
                d[24] = src[j+2+32*24]; d[25] = src[j+2+32*25]; d[26] = src[j+2+32*26]; d[27] = src[j+2+32*27];
                d[28] = src[j+2+32*28]; d[29] = src[j+2+32*29]; d[30] = src[j+2+32*30]; d[31] = src[j+2+32*31];
                d[32] = src[j+2+32*32]; d[33] = src[j+2+32*33]; d[34] = src[j+2+32*34]; d[35] = src[j+2+32*35];
                d[36] = src[j+2+32*36]; d[37] = src[j+2+32*37]; d[38] = src[j+2+32*38]; d[39] = src[j+2+32*39];
                d[40] = src[j+2+32*40]; d[41] = src[j+2+32*41]; d[42] = src[j+2+32*42]; d[43] = src[j+2+32*43];
                d[44] = src[j+2+32*44]; d[45] = src[j+2+32*45]; d[46] = src[j+2+32*46]; d[47] = src[j+2+32*47];
                d[48] = src[j+2+32*48]; d[49] = src[j+2+32*49]; d[50] = src[j+2+32*50]; d[51] = src[j+2+32*51];
                d[52] = src[j+2+32*52]; d[53] = src[j+2+32*53]; d[54] = src[j+2+32*54]; d[55] = src[j+2+32*55];
                d[56] = src[j+2+32*56]; d[57] = src[j+2+32*57]; d[58] = src[j+2+32*58]; d[59] = src[j+2+32*59];
                d[60] = src[j+2+32*60]; d[61] = src[j+2+32*61]; d[62] = src[j+2+32*62]; d[63] = src[j+2+32*63];
                d = dst[j+3];
                d[ 0] = src[j+3+32* 0]; d[ 1] = src[j+3+32* 1]; d[ 2] = src[j+3+32* 2]; d[ 3] = src[j+3+32* 3];
                d[ 4] = src[j+3+32* 4]; d[ 5] = src[j+3+32* 5]; d[ 6] = src[j+3+32* 6]; d[ 7] = src[j+3+32* 7];
                d[ 8] = src[j+3+32* 8]; d[ 9] = src[j+3+32* 9]; d[10] = src[j+3+32*10]; d[11] = src[j+3+32*11];
                d[12] = src[j+3+32*12]; d[13] = src[j+3+32*13]; d[14] = src[j+3+32*14]; d[15] = src[j+3+32*15];
                d[16] = src[j+3+32*16]; d[17] = src[j+3+32*17]; d[18] = src[j+3+32*18]; d[19] = src[j+3+32*19];
                d[20] = src[j+3+32*20]; d[21] = src[j+3+32*21]; d[22] = src[j+3+32*22]; d[23] = src[j+3+32*23];
                d[24] = src[j+3+32*24]; d[25] = src[j+3+32*25]; d[26] = src[j+3+32*26]; d[27] = src[j+3+32*27];
                d[28] = src[j+3+32*28]; d[29] = src[j+3+32*29]; d[30] = src[j+3+32*30]; d[31] = src[j+3+32*31];
                d[32] = src[j+3+32*32]; d[33] = src[j+3+32*33]; d[34] = src[j+3+32*34]; d[35] = src[j+3+32*35];
                d[36] = src[j+3+32*36]; d[37] = src[j+3+32*37]; d[38] = src[j+3+32*38]; d[39] = src[j+3+32*39];
                d[40] = src[j+3+32*40]; d[41] = src[j+3+32*41]; d[42] = src[j+3+32*42]; d[43] = src[j+3+32*43];
                d[44] = src[j+3+32*44]; d[45] = src[j+3+32*45]; d[46] = src[j+3+32*46]; d[47] = src[j+3+32*47];
                d[48] = src[j+3+32*48]; d[49] = src[j+3+32*49]; d[50] = src[j+3+32*50]; d[51] = src[j+3+32*51];
                d[52] = src[j+3+32*52]; d[53] = src[j+3+32*53]; d[54] = src[j+3+32*54]; d[55] = src[j+3+32*55];
                d[56] = src[j+3+32*56]; d[57] = src[j+3+32*57]; d[58] = src[j+3+32*58]; d[59] = src[j+3+32*59];
                d[60] = src[j+3+32*60]; d[61] = src[j+3+32*61]; d[62] = src[j+3+32*62]; d[63] = src[j+3+32*63];
            }
        }
    }

    static final class Unrolled_1_8 implements Demux
    {
        public void demux (byte[] src, byte[][] dst)
        {
            assert NUM_TIMESLOTS == 32;
            ...
            for (int j = 0; j < NUM_TIMESLOTS; j+=8) {
                byte[] d;
                d = dst[j+0];
                d[ 0] = src[j+0+32* 0]; d[ 1] = src[j+0+32* 1]; d[ 2] = src[j+0+32* 2]; d[ 3] = src[j+0+32* 3];
                d[ 4] = src[j+0+32* 4]; d[ 5] = src[j+0+32* 5]; d[ 6] = src[j+0+32* 6]; d[ 7] = src[j+0+32* 7];
                ...
                d[60] = src[j+3+32*60]; d[61] = src[j+3+32*61]; d[62] = src[j+3+32*62]; d[63] = src[j+3+32*63];
                d = dst[j+4];
                d[ 0] = src[j+4+32* 0]; d[ 1] = src[j+4+32* 1]; d[ 2] = src[j+4+32* 2]; d[ 3] = src[j+4+32* 3];
                d[ 4] = src[j+4+32* 4]; d[ 5] = src[j+4+32* 5]; d[ 6] = src[j+4+32* 6]; d[ 7] = src[j+4+32* 7];
                d[ 8] = src[j+4+32* 8]; d[ 9] = src[j+4+32* 9]; d[10] = src[j+4+32*10]; d[11] = src[j+4+32*11];
                d[12] = src[j+4+32*12]; d[13] = src[j+4+32*13]; d[14] = src[j+4+32*14]; d[15] = src[j+4+32*15];
                d[16] = src[j+4+32*16]; d[17] = src[j+4+32*17]; d[18] = src[j+4+32*18]; d[19] = src[j+4+32*19];
                d[20] = src[j+4+32*20]; d[21] = src[j+4+32*21]; d[22] = src[j+4+32*22]; d[23] = src[j+4+32*23];
                d[24] = src[j+4+32*24]; d[25] = src[j+4+32*25]; d[26] = src[j+4+32*26]; d[27] = src[j+4+32*27];
                d[28] = src[j+4+32*28]; d[29] = src[j+4+32*29]; d[30] = src[j+4+32*30]; d[31] = src[j+4+32*31];
                d[32] = src[j+4+32*32]; d[33] = src[j+4+32*33]; d[34] = src[j+4+32*34]; d[35] = src[j+4+32*35];
                d[36] = src[j+4+32*36]; d[37] = src[j+4+32*37]; d[38] = src[j+4+32*38]; d[39] = src[j+4+32*39];
                d[40] = src[j+4+32*40]; d[41] = src[j+4+32*41]; d[42] = src[j+4+32*42]; d[43] = src[j+4+32*43];
                d[44] = src[j+4+32*44]; d[45] = src[j+4+32*45]; d[46] = src[j+4+32*46]; d[47] = src[j+4+32*47];
                d[48] = src[j+4+32*48]; d[49] = src[j+4+32*49]; d[50] = src[j+4+32*50]; d[51] = src[j+4+32*51];
                d[52] = src[j+4+32*52]; d[53] = src[j+4+32*53]; d[54] = src[j+4+32*54]; d[55] = src[j+4+32*55];
                d[56] = src[j+4+32*56]; d[57] = src[j+4+32*57]; d[58] = src[j+4+32*58]; d[59] = src[j+4+32*59];
                d[60] = src[j+4+32*60]; d[61] = src[j+4+32*61]; d[62] = src[j+4+32*62]; d[63] = src[j+4+32*63];
                d = dst[j+5];
                d[ 0] = src[j+5+32* 0]; d[ 1] = src[j+5+32* 1]; d[ 2] = src[j+5+32* 2]; d[ 3] = src[j+5+32* 3];
                d[ 4] = src[j+5+32* 4]; d[ 5] = src[j+5+32* 5]; d[ 6] = src[j+5+32* 6]; d[ 7] = src[j+5+32* 7];
                d[ 8] = src[j+5+32* 8]; d[ 9] = src[j+5+32* 9]; d[10] = src[j+5+32*10]; d[11] = src[j+5+32*11];
                d[12] = src[j+5+32*12]; d[13] = src[j+5+32*13]; d[14] = src[j+5+32*14]; d[15] = src[j+5+32*15];
                d[16] = src[j+5+32*16]; d[17] = src[j+5+32*17]; d[18] = src[j+5+32*18]; d[19] = src[j+5+32*19];
                d[20] = src[j+5+32*20]; d[21] = src[j+5+32*21]; d[22] = src[j+5+32*22]; d[23] = src[j+5+32*23];
                d[24] = src[j+5+32*24]; d[25] = src[j+5+32*25]; d[26] = src[j+5+32*26]; d[27] = src[j+5+32*27];
                d[28] = src[j+5+32*28]; d[29] = src[j+5+32*29]; d[30] = src[j+5+32*30]; d[31] = src[j+5+32*31];
                d[32] = src[j+5+32*32]; d[33] = src[j+5+32*33]; d[34] = src[j+5+32*34]; d[35] = src[j+5+32*35];
                d[36] = src[j+5+32*36]; d[37] = src[j+5+32*37]; d[38] = src[j+5+32*38]; d[39] = src[j+5+32*39];
                d[40] = src[j+5+32*40]; d[41] = src[j+5+32*41]; d[42] = src[j+5+32*42]; d[43] = src[j+5+32*43];
                d[44] = src[j+5+32*44]; d[45] = src[j+5+32*45]; d[46] = src[j+5+32*46]; d[47] = src[j+5+32*47];
                d[48] = src[j+5+32*48]; d[49] = src[j+5+32*49]; d[50] = src[j+5+32*50]; d[51] = src[j+5+32*51];
                d[52] = src[j+5+32*52]; d[53] = src[j+5+32*53]; d[54] = src[j+5+32*54]; d[55] = src[j+5+32*55];
                d[56] = src[j+5+32*56]; d[57] = src[j+5+32*57]; d[58] = src[j+5+32*58]; d[59] = src[j+5+32*59];
                d[60] = src[j+5+32*60]; d[61] = src[j+5+32*61]; d[62] = src[j+5+32*62]; d[63] = src[j+5+32*63];
                d = dst[j+6];
                d[ 0] = src[j+6+32* 0]; d[ 1] = src[j+6+32* 1]; d[ 2] = src[j+6+32* 2]; d[ 3] = src[j+6+32* 3];
                d[ 4] = src[j+6+32* 4]; d[ 5] = src[j+6+32* 5]; d[ 6] = src[j+6+32* 6]; d[ 7] = src[j+6+32* 7];
                d[ 8] = src[j+6+32* 8]; d[ 9] = src[j+6+32* 9]; d[10] = src[j+6+32*10]; d[11] = src[j+6+32*11];
                d[12] = src[j+6+32*12]; d[13] = src[j+6+32*13]; d[14] = src[j+6+32*14]; d[15] = src[j+6+32*15];
                d[16] = src[j+6+32*16]; d[17] = src[j+6+32*17]; d[18] = src[j+6+32*18]; d[19] = src[j+6+32*19];
                d[20] = src[j+6+32*20]; d[21] = src[j+6+32*21]; d[22] = src[j+6+32*22]; d[23] = src[j+6+32*23];
                d[24] = src[j+6+32*24]; d[25] = src[j+6+32*25]; d[26] = src[j+6+32*26]; d[27] = src[j+6+32*27];
                d[28] = src[j+6+32*28]; d[29] = src[j+6+32*29]; d[30] = src[j+6+32*30]; d[31] = src[j+6+32*31];
                d[32] = src[j+6+32*32]; d[33] = src[j+6+32*33]; d[34] = src[j+6+32*34]; d[35] = src[j+6+32*35];
                d[36] = src[j+6+32*36]; d[37] = src[j+6+32*37]; d[38] = src[j+6+32*38]; d[39] = src[j+6+32*39];
                d[40] = src[j+6+32*40]; d[41] = src[j+6+32*41]; d[42] = src[j+6+32*42]; d[43] = src[j+6+32*43];
                d[44] = src[j+6+32*44]; d[45] = src[j+6+32*45]; d[46] = src[j+6+32*46]; d[47] = src[j+6+32*47];
                d[48] = src[j+6+32*48]; d[49] = src[j+6+32*49]; d[50] = src[j+6+32*50]; d[51] = src[j+6+32*51];
                d[52] = src[j+6+32*52]; d[53] = src[j+6+32*53]; d[54] = src[j+6+32*54]; d[55] = src[j+6+32*55];
                d[56] = src[j+6+32*56]; d[57] = src[j+6+32*57]; d[58] = src[j+6+32*58]; d[59] = src[j+6+32*59];
                d[60] = src[j+6+32*60]; d[61] = src[j+6+32*61]; d[62] = src[j+6+32*62]; d[63] = src[j+6+32*63];
                d = dst[j+7];
                d[ 0] = src[j+7+32* 0]; d[ 1] = src[j+7+32* 1]; d[ 2] = src[j+7+32* 2]; d[ 3] = src[j+7+32* 3];
                d[ 4] = src[j+7+32* 4]; d[ 5] = src[j+7+32* 5]; d[ 6] = src[j+7+32* 6]; d[ 7] = src[j+7+32* 7];
                d[ 8] = src[j+7+32* 8]; d[ 9] = src[j+7+32* 9]; d[10] = src[j+7+32*10]; d[11] = src[j+7+32*11];
                d[12] = src[j+7+32*12]; d[13] = src[j+7+32*13]; d[14] = src[j+7+32*14]; d[15] = src[j+7+32*15];
                d[16] = src[j+7+32*16]; d[17] = src[j+7+32*17]; d[18] = src[j+7+32*18]; d[19] = src[j+7+32*19];
                d[20] = src[j+7+32*20]; d[21] = src[j+7+32*21]; d[22] = src[j+7+32*22]; d[23] = src[j+7+32*23];
                d[24] = src[j+7+32*24]; d[25] = src[j+7+32*25]; d[26] = src[j+7+32*26]; d[27] = src[j+7+32*27];
                d[28] = src[j+7+32*28]; d[29] = src[j+7+32*29]; d[30] = src[j+7+32*30]; d[31] = src[j+7+32*31];
                d[32] = src[j+7+32*32]; d[33] = src[j+7+32*33]; d[34] = src[j+7+32*34]; d[35] = src[j+7+32*35];
                d[36] = src[j+7+32*36]; d[37] = src[j+7+32*37]; d[38] = src[j+7+32*38]; d[39] = src[j+7+32*39];
                d[40] = src[j+7+32*40]; d[41] = src[j+7+32*41]; d[42] = src[j+7+32*42]; d[43] = src[j+7+32*43];
                d[44] = src[j+7+32*44]; d[45] = src[j+7+32*45]; d[46] = src[j+7+32*46]; d[47] = src[j+7+32*47];
                d[48] = src[j+7+32*48]; d[49] = src[j+7+32*49]; d[50] = src[j+7+32*50]; d[51] = src[j+7+32*51];
                d[52] = src[j+7+32*52]; d[53] = src[j+7+32*53]; d[54] = src[j+7+32*54]; d[55] = src[j+7+32*55];
                d[56] = src[j+7+32*56]; d[57] = src[j+7+32*57]; d[58] = src[j+7+32*58]; d[59] = src[j+7+32*59];
                d[60] = src[j+7+32*60]; d[61] = src[j+7+32*61]; d[62] = src[j+7+32*62]; d[63] = src[j+7+32*63];
            }
        }
    }

    static final class Unrolled_1_16 implements Demux
    {
        public void demux (byte[] src, byte[][] dst)
        {
            assert NUM_TIMESLOTS == 32;
            ...
            for (int j = 0; j < NUM_TIMESLOTS; j+=16) {
                byte[] d;
                d = dst[j+0];
                d[ 0] = src[j+0+32* 0]; d[ 1] = src[j+0+32* 1]; d[ 2] = src[j+0+32* 2]; d[ 3] = src[j+0+32* 3];
                d[ 4] = src[j+0+32* 4]; d[ 5] = src[j+0+32* 5]; d[ 6] = src[j+0+32* 6]; d[ 7] = src[j+0+32* 7];
                ...
                d[60] = src[j+7+32*60]; d[61] = src[j+7+32*61]; d[62] = src[j+7+32*62]; d[63] = src[j+7+32*63];
                d = dst[j+8];
                d[ 0] = src[j+8+32* 0]; d[ 1] = src[j+8+32* 1]; d[ 2] = src[j+8+32* 2]; d[ 3] = src[j+8+32* 3];
                d[ 4] = src[j+8+32* 4]; d[ 5] = src[j+8+32* 5]; d[ 6] = src[j+8+32* 6]; d[ 7] = src[j+8+32* 7];
                d[ 8] = src[j+8+32* 8]; d[ 9] = src[j+8+32* 9]; d[10] = src[j+8+32*10]; d[11] = src[j+8+32*11];
                d[12] = src[j+8+32*12]; d[13] = src[j+8+32*13]; d[14] = src[j+8+32*14]; d[15] = src[j+8+32*15];
                d[16] = src[j+8+32*16]; d[17] = src[j+8+32*17]; d[18] = src[j+8+32*18]; d[19] = src[j+8+32*19];
                d[20] = src[j+8+32*20]; d[21] = src[j+8+32*21]; d[22] = src[j+8+32*22]; d[23] = src[j+8+32*23];
                d[24] = src[j+8+32*24]; d[25] = src[j+8+32*25]; d[26] = src[j+8+32*26]; d[27] = src[j+8+32*27];
                d[28] = src[j+8+32*28]; d[29] = src[j+8+32*29]; d[30] = src[j+8+32*30]; d[31] = src[j+8+32*31];
                d[32] = src[j+8+32*32]; d[33] = src[j+8+32*33]; d[34] = src[j+8+32*34]; d[35] = src[j+8+32*35];
                d[36] = src[j+8+32*36]; d[37] = src[j+8+32*37]; d[38] = src[j+8+32*38]; d[39] = src[j+8+32*39];
                d[40] = src[j+8+32*40]; d[41] = src[j+8+32*41]; d[42] = src[j+8+32*42]; d[43] = src[j+8+32*43];
                d[44] = src[j+8+32*44]; d[45] = src[j+8+32*45]; d[46] = src[j+8+32*46]; d[47] = src[j+8+32*47];
                d[48] = src[j+8+32*48]; d[49] = src[j+8+32*49]; d[50] = src[j+8+32*50]; d[51] = src[j+8+32*51];
                d[52] = src[j+8+32*52]; d[53] = src[j+8+32*53]; d[54] = src[j+8+32*54]; d[55] = src[j+8+32*55];
                d[56] = src[j+8+32*56]; d[57] = src[j+8+32*57]; d[58] = src[j+8+32*58]; d[59] = src[j+8+32*59];
                d[60] = src[j+8+32*60]; d[61] = src[j+8+32*61]; d[62] = src[j+8+32*62]; d[63] = src[j+8+32*63];
                d = dst[j+9];
                d[ 0] = src[j+9+32* 0]; d[ 1] = src[j+9+32* 1]; d[ 2] = src[j+9+32* 2]; d[ 3] = src[j+9+32* 3];
                d[ 4] = src[j+9+32* 4]; d[ 5] = src[j+9+32* 5]; d[ 6] = src[j+9+32* 6]; d[ 7] = src[j+9+32* 7];
                d[ 8] = src[j+9+32* 8]; d[ 9] = src[j+9+32* 9]; d[10] = src[j+9+32*10]; d[11] = src[j+9+32*11];
                d[12] = src[j+9+32*12]; d[13] = src[j+9+32*13]; d[14] = src[j+9+32*14]; d[15] = src[j+9+32*15];
                d[16] = src[j+9+32*16]; d[17] = src[j+9+32*17]; d[18] = src[j+9+32*18]; d[19] = src[j+9+32*19];
                d[20] = src[j+9+32*20]; d[21] = src[j+9+32*21]; d[22] = src[j+9+32*22]; d[23] = src[j+9+32*23];
                d[24] = src[j+9+32*24]; d[25] = src[j+9+32*25]; d[26] = src[j+9+32*26]; d[27] = src[j+9+32*27];
                d[28] = src[j+9+32*28]; d[29] = src[j+9+32*29]; d[30] = src[j+9+32*30]; d[31] = src[j+9+32*31];
                d[32] = src[j+9+32*32]; d[33] = src[j+9+32*33]; d[34] = src[j+9+32*34]; d[35] = src[j+9+32*35];
                d[36] = src[j+9+32*36]; d[37] = src[j+9+32*37]; d[38] = src[j+9+32*38]; d[39] = src[j+9+32*39];
                d[40] = src[j+9+32*40]; d[41] = src[j+9+32*41]; d[42] = src[j+9+32*42]; d[43] = src[j+9+32*43];
                d[44] = src[j+9+32*44]; d[45] = src[j+9+32*45]; d[46] = src[j+9+32*46]; d[47] = src[j+9+32*47];
                d[48] = src[j+9+32*48]; d[49] = src[j+9+32*49]; d[50] = src[j+9+32*50]; d[51] = src[j+9+32*51];
                d[52] = src[j+9+32*52]; d[53] = src[j+9+32*53]; d[54] = src[j+9+32*54]; d[55] = src[j+9+32*55];
                d[56] = src[j+9+32*56]; d[57] = src[j+9+32*57]; d[58] = src[j+9+32*58]; d[59] = src[j+9+32*59];
                d[60] = src[j+9+32*60]; d[61] = src[j+9+32*61]; d[62] = src[j+9+32*62]; d[63] = src[j+9+32*63];
                d = dst[j+10];
                d[ 0] = src[j+10+32* 0]; d[ 1] = src[j+10+32* 1]; d[ 2] = src[j+10+32* 2]; d[ 3] = src[j+10+32* 3];
                d[ 4] = src[j+10+32* 4]; d[ 5] = src[j+10+32* 5]; d[ 6] = src[j+10+32* 6]; d[ 7] = src[j+10+32* 7];
                d[ 8] = src[j+10+32* 8]; d[ 9] = src[j+10+32* 9]; d[10] = src[j+10+32*10]; d[11] = src[j+10+32*11];
                d[12] = src[j+10+32*12]; d[13] = src[j+10+32*13]; d[14] = src[j+10+32*14]; d[15] = src[j+10+32*15];
                d[16] = src[j+10+32*16]; d[17] = src[j+10+32*17]; d[18] = src[j+10+32*18]; d[19] = src[j+10+32*19];
                d[20] = src[j+10+32*20]; d[21] = src[j+10+32*21]; d[22] = src[j+10+32*22]; d[23] = src[j+10+32*23];
                d[24] = src[j+10+32*24]; d[25] = src[j+10+32*25]; d[26] = src[j+10+32*26]; d[27] = src[j+10+32*27];
                d[28] = src[j+10+32*28]; d[29] = src[j+10+32*29]; d[30] = src[j+10+32*30]; d[31] = src[j+10+32*31];
                d[32] = src[j+10+32*32]; d[33] = src[j+10+32*33]; d[34] = src[j+10+32*34]; d[35] = src[j+10+32*35];
                d[36] = src[j+10+32*36]; d[37] = src[j+10+32*37]; d[38] = src[j+10+32*38]; d[39] = src[j+10+32*39];
                d[40] = src[j+10+32*40]; d[41] = src[j+10+32*41]; d[42] = src[j+10+32*42]; d[43] = src[j+10+32*43];
                d[44] = src[j+10+32*44]; d[45] = src[j+10+32*45]; d[46] = src[j+10+32*46]; d[47] = src[j+10+32*47];
                d[48] = src[j+10+32*48]; d[49] = src[j+10+32*49]; d[50] = src[j+10+32*50]; d[51] = src[j+10+32*51];
                d[52] = src[j+10+32*52]; d[53] = src[j+10+32*53]; d[54] = src[j+10+32*54]; d[55] = src[j+10+32*55];
                d[56] = src[j+10+32*56]; d[57] = src[j+10+32*57]; d[58] = src[j+10+32*58]; d[59] = src[j+10+32*59];
                d[60] = src[j+10+32*60]; d[61] = src[j+10+32*61]; d[62] = src[j+10+32*62]; d[63] = src[j+10+32*63];
                d = dst[j+11];
                d[ 0] = src[j+11+32* 0]; d[ 1] = src[j+11+32* 1]; d[ 2] = src[j+11+32* 2]; d[ 3] = src[j+11+32* 3];
                d[ 4] = src[j+11+32* 4]; d[ 5] = src[j+11+32* 5]; d[ 6] = src[j+11+32* 6]; d[ 7] = src[j+11+32* 7];
                d[ 8] = src[j+11+32* 8]; d[ 9] = src[j+11+32* 9]; d[10] = src[j+11+32*10]; d[11] = src[j+11+32*11];
                d[12] = src[j+11+32*12]; d[13] = src[j+11+32*13]; d[14] = src[j+11+32*14]; d[15] = src[j+11+32*15];
                d[16] = src[j+11+32*16]; d[17] = src[j+11+32*17]; d[18] = src[j+11+32*18]; d[19] = src[j+11+32*19];
                d[20] = src[j+11+32*20]; d[21] = src[j+11+32*21]; d[22] = src[j+11+32*22]; d[23] = src[j+11+32*23];
                d[24] = src[j+11+32*24]; d[25] = src[j+11+32*25]; d[26] = src[j+11+32*26]; d[27] = src[j+11+32*27];
                d[28] = src[j+11+32*28]; d[29] = src[j+11+32*29]; d[30] = src[j+11+32*30]; d[31] = src[j+11+32*31];
                d[32] = src[j+11+32*32]; d[33] = src[j+11+32*33]; d[34] = src[j+11+32*34]; d[35] = src[j+11+32*35];
                d[36] = src[j+11+32*36]; d[37] = src[j+11+32*37]; d[38] = src[j+11+32*38]; d[39] = src[j+11+32*39];
                d[40] = src[j+11+32*40]; d[41] = src[j+11+32*41]; d[42] = src[j+11+32*42]; d[43] = src[j+11+32*43];
                d[44] = src[j+11+32*44]; d[45] = src[j+11+32*45]; d[46] = src[j+11+32*46]; d[47] = src[j+11+32*47];
                d[48] = src[j+11+32*48]; d[49] = src[j+11+32*49]; d[50] = src[j+11+32*50]; d[51] = src[j+11+32*51];
                d[52] = src[j+11+32*52]; d[53] = src[j+11+32*53]; d[54] = src[j+11+32*54]; d[55] = src[j+11+32*55];
                d[56] = src[j+11+32*56]; d[57] = src[j+11+32*57]; d[58] = src[j+11+32*58]; d[59] = src[j+11+32*59];
                d[60] = src[j+11+32*60]; d[61] = src[j+11+32*61]; d[62] = src[j+11+32*62]; d[63] = src[j+11+32*63];
                d = dst[j+12];
                d[ 0] = src[j+12+32* 0]; d[ 1] = src[j+12+32* 1]; d[ 2] = src[j+12+32* 2]; d[ 3] = src[j+12+32* 3];
                d[ 4] = src[j+12+32* 4]; d[ 5] = src[j+12+32* 5]; d[ 6] = src[j+12+32* 6]; d[ 7] = src[j+12+32* 7];
                d[ 8] = src[j+12+32* 8]; d[ 9] = src[j+12+32* 9]; d[10] = src[j+12+32*10]; d[11] = src[j+12+32*11];
                d[12] = src[j+12+32*12]; d[13] = src[j+12+32*13]; d[14] = src[j+12+32*14]; d[15] = src[j+12+32*15];
                d[16] = src[j+12+32*16]; d[17] = src[j+12+32*17]; d[18] = src[j+12+32*18]; d[19] = src[j+12+32*19];
                d[20] = src[j+12+32*20]; d[21] = src[j+12+32*21]; d[22] = src[j+12+32*22]; d[23] = src[j+12+32*23];
                d[24] = src[j+12+32*24]; d[25] = src[j+12+32*25]; d[26] = src[j+12+32*26]; d[27] = src[j+12+32*27];
                d[28] = src[j+12+32*28]; d[29] = src[j+12+32*29]; d[30] = src[j+12+32*30]; d[31] = src[j+12+32*31];
                d[32] = src[j+12+32*32]; d[33] = src[j+12+32*33]; d[34] = src[j+12+32*34]; d[35] = src[j+12+32*35];
                d[36] = src[j+12+32*36]; d[37] = src[j+12+32*37]; d[38] = src[j+12+32*38]; d[39] = src[j+12+32*39];
                d[40] = src[j+12+32*40]; d[41] = src[j+12+32*41]; d[42] = src[j+12+32*42]; d[43] = src[j+12+32*43];
                d[44] = src[j+12+32*44]; d[45] = src[j+12+32*45]; d[46] = src[j+12+32*46]; d[47] = src[j+12+32*47];
                d[48] = src[j+12+32*48]; d[49] = src[j+12+32*49]; d[50] = src[j+12+32*50]; d[51] = src[j+12+32*51];
                d[52] = src[j+12+32*52]; d[53] = src[j+12+32*53]; d[54] = src[j+12+32*54]; d[55] = src[j+12+32*55];
                d[56] = src[j+12+32*56]; d[57] = src[j+12+32*57]; d[58] = src[j+12+32*58]; d[59] = src[j+12+32*59];
                d[60] = src[j+12+32*60]; d[61] = src[j+12+32*61]; d[62] = src[j+12+32*62]; d[63] = src[j+12+32*63];
                d = dst[j+13];
                d[ 0] = src[j+13+32* 0]; d[ 1] = src[j+13+32* 1]; d[ 2] = src[j+13+32* 2]; d[ 3] = src[j+13+32* 3];
                d[ 4] = src[j+13+32* 4]; d[ 5] = src[j+13+32* 5]; d[ 6] = src[j+13+32* 6]; d[ 7] = src[j+13+32* 7];
                d[ 8] = src[j+13+32* 8]; d[ 9] = src[j+13+32* 9]; d[10] = src[j+13+32*10]; d[11] = src[j+13+32*11];
                d[12] = src[j+13+32*12]; d[13] = src[j+13+32*13]; d[14] = src[j+13+32*14]; d[15] = src[j+13+32*15];
                d[16] = src[j+13+32*16]; d[17] = src[j+13+32*17]; d[18] = src[j+13+32*18]; d[19] = src[j+13+32*19];
                d[20] = src[j+13+32*20]; d[21] = src[j+13+32*21]; d[22] = src[j+13+32*22]; d[23] = src[j+13+32*23];
                d[24] = src[j+13+32*24]; d[25] = src[j+13+32*25]; d[26] = src[j+13+32*26]; d[27] = src[j+13+32*27];
                d[28] = src[j+13+32*28]; d[29] = src[j+13+32*29]; d[30] = src[j+13+32*30]; d[31] = src[j+13+32*31];
                d[32] = src[j+13+32*32]; d[33] = src[j+13+32*33]; d[34] = src[j+13+32*34]; d[35] = src[j+13+32*35];
                d[36] = src[j+13+32*36]; d[37] = src[j+13+32*37]; d[38] = src[j+13+32*38]; d[39] = src[j+13+32*39];
                d[40] = src[j+13+32*40]; d[41] = src[j+13+32*41]; d[42] = src[j+13+32*42]; d[43] = src[j+13+32*43];
                d[44] = src[j+13+32*44]; d[45] = src[j+13+32*45]; d[46] = src[j+13+32*46]; d[47] = src[j+13+32*47];
                d[48] = src[j+13+32*48]; d[49] = src[j+13+32*49]; d[50] = src[j+13+32*50]; d[51] = src[j+13+32*51];
                d[52] = src[j+13+32*52]; d[53] = src[j+13+32*53]; d[54] = src[j+13+32*54]; d[55] = src[j+13+32*55];
                d[56] = src[j+13+32*56]; d[57] = src[j+13+32*57]; d[58] = src[j+13+32*58]; d[59] = src[j+13+32*59];
                d[60] = src[j+13+32*60]; d[61] = src[j+13+32*61]; d[62] = src[j+13+32*62]; d[63] = src[j+13+32*63];
                d = dst[j+14];
                d[ 0] = src[j+14+32* 0]; d[ 1] = src[j+14+32* 1]; d[ 2] = src[j+14+32* 2]; d[ 3] = src[j+14+32* 3];
                d[ 4] = src[j+14+32* 4]; d[ 5] = src[j+14+32* 5]; d[ 6] = src[j+14+32* 6]; d[ 7] = src[j+14+32* 7];
                d[ 8] = src[j+14+32* 8]; d[ 9] = src[j+14+32* 9]; d[10] = src[j+14+32*10]; d[11] = src[j+14+32*11];
                d[12] = src[j+14+32*12]; d[13] = src[j+14+32*13]; d[14] = src[j+14+32*14]; d[15] = src[j+14+32*15];
                d[16] = src[j+14+32*16]; d[17] = src[j+14+32*17]; d[18] = src[j+14+32*18]; d[19] = src[j+14+32*19];
                d[20] = src[j+14+32*20]; d[21] = src[j+14+32*21]; d[22] = src[j+14+32*22]; d[23] = src[j+14+32*23];
                d[24] = src[j+14+32*24]; d[25] = src[j+14+32*25]; d[26] = src[j+14+32*26]; d[27] = src[j+14+32*27];
                d[28] = src[j+14+32*28]; d[29] = src[j+14+32*29]; d[30] = src[j+14+32*30]; d[31] = src[j+14+32*31];
                d[32] = src[j+14+32*32]; d[33] = src[j+14+32*33]; d[34] = src[j+14+32*34]; d[35] = src[j+14+32*35];
                d[36] = src[j+14+32*36]; d[37] = src[j+14+32*37]; d[38] = src[j+14+32*38]; d[39] = src[j+14+32*39];
                d[40] = src[j+14+32*40]; d[41] = src[j+14+32*41]; d[42] = src[j+14+32*42]; d[43] = src[j+14+32*43];
                d[44] = src[j+14+32*44]; d[45] = src[j+14+32*45]; d[46] = src[j+14+32*46]; d[47] = src[j+14+32*47];
                d[48] = src[j+14+32*48]; d[49] = src[j+14+32*49]; d[50] = src[j+14+32*50]; d[51] = src[j+14+32*51];
                d[52] = src[j+14+32*52]; d[53] = src[j+14+32*53]; d[54] = src[j+14+32*54]; d[55] = src[j+14+32*55];
                d[56] = src[j+14+32*56]; d[57] = src[j+14+32*57]; d[58] = src[j+14+32*58]; d[59] = src[j+14+32*59];
                d[60] = src[j+14+32*60]; d[61] = src[j+14+32*61]; d[62] = src[j+14+32*62]; d[63] = src[j+14+32*63];
                d = dst[j+15];
                d[ 0] = src[j+15+32* 0]; d[ 1] = src[j+15+32* 1]; d[ 2] = src[j+15+32* 2]; d[ 3] = src[j+15+32* 3];
                d[ 4] = src[j+15+32* 4]; d[ 5] = src[j+15+32* 5]; d[ 6] = src[j+15+32* 6]; d[ 7] = src[j+15+32* 7];
                d[ 8] = src[j+15+32* 8]; d[ 9] = src[j+15+32* 9]; d[10] = src[j+15+32*10]; d[11] = src[j+15+32*11];
                d[12] = src[j+15+32*12]; d[13] = src[j+15+32*13]; d[14] = src[j+15+32*14]; d[15] = src[j+15+32*15];
                d[16] = src[j+15+32*16]; d[17] = src[j+15+32*17]; d[18] = src[j+15+32*18]; d[19] = src[j+15+32*19];
                d[20] = src[j+15+32*20]; d[21] = src[j+15+32*21]; d[22] = src[j+15+32*22]; d[23] = src[j+15+32*23];
                d[24] = src[j+15+32*24]; d[25] = src[j+15+32*25]; d[26] = src[j+15+32*26]; d[27] = src[j+15+32*27];
                d[28] = src[j+15+32*28]; d[29] = src[j+15+32*29]; d[30] = src[j+15+32*30]; d[31] = src[j+15+32*31];
                d[32] = src[j+15+32*32]; d[33] = src[j+15+32*33]; d[34] = src[j+15+32*34]; d[35] = src[j+15+32*35];
                d[36] = src[j+15+32*36]; d[37] = src[j+15+32*37]; d[38] = src[j+15+32*38]; d[39] = src[j+15+32*39];
                d[40] = src[j+15+32*40]; d[41] = src[j+15+32*41]; d[42] = src[j+15+32*42]; d[43] = src[j+15+32*43];
                d[44] = src[j+15+32*44]; d[45] = src[j+15+32*45]; d[46] = src[j+15+32*46]; d[47] = src[j+15+32*47];
                d[48] = src[j+15+32*48]; d[49] = src[j+15+32*49]; d[50] = src[j+15+32*50]; d[51] = src[j+15+32*51];
                d[52] = src[j+15+32*52]; d[53] = src[j+15+32*53]; d[54] = src[j+15+32*54]; d[55] = src[j+15+32*55];
                d[56] = src[j+15+32*56]; d[57] = src[j+15+32*57]; d[58] = src[j+15+32*58]; d[59] = src[j+15+32*59];
                d[60] = src[j+15+32*60]; d[61] = src[j+15+32*61]; d[62] = src[j+15+32*62]; d[63] = src[j+15+32*63];
            }
        }
    }
...
//      measure (new Unrolled_1_2 ());
//      measure (new Unrolled_1_4 ());
//      measure (new Unrolled_1_8 ());
        measure (new Unrolled_1_16 ());
    }
}
